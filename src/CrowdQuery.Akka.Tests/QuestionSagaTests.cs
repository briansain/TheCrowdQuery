...
using CrowdQuery.Akka.Sagas.QuestionSaga;
using CrowdQuery.Akka.Sagas.QuestionSaga.Commands;
using CrowdQuery.Akka.Sagas.QuestionSaga.Events;
using CrowdQuery.Akka.Sagas.QuestionSaga.ResponseModels;
using Xunit;
using AnswerVoteDecreased = CrowdQuery.Akka.Sagas.QuestionSaga.Events.AnswerVoteDecreased;
using AnswerVoteIncreased = CrowdQuery.Akka.Sagas.QuestionSaga.Events.AnswerVoteIncreased;
...
namespace CrowdQuery.Akka.Tests
{
	public class QuestionSagaTests : TestKit
	{
		...
		public void SubscribesTo_AnswerVoteIncreased_EmitsAnswerVoteIncreased()
		{
			...
			var answerIncreased = new Akka.Actors.Question.Events.AnswerVoteIncreased("Yes");

			questionSaga.Tell(new DomainEvent<QuestionActor, QuestionId, Akka.Actors.Question.Events.AnswerVoteIncreased>(
		...
		public void SubscribesTo_AnswerVoteDecreased_EmitsAnswerVoteDecreased()
		{
			...
			var answerVoteDecreased = new Akka.Actors.Question.Events.AnswerVoteDecreased("Yes");


			questionSaga.Tell(new DomainEvent<QuestionActor, QuestionId, Akka.Actors.Question.Events.AnswerVoteDecreased>(
		...
		public void SubscribesTo_AnswerVoteDecreased_NotifiesSubscribers()
		{
			...
			var command = new SubscribeToQuestion(questionSagaId, _testProbe);
			questionSaga.Tell(command);
			var answerIncreased = new Akka.Actors.Question.Events.AnswerVoteDecreased("Yes");
